...
export default function Promotions() {
  ...
  const PromotionArray = [
    {
      PromotionAmount: 25,
      PromotionLocation: "Williams Fresh Cafe",
        ...
        {PromotionArray.map((Promotion) => {
          return (
            <PromotionRow
              ...
              promotionEndDate={Promotion.PromotionDate}
  ...
  return (
    <SafeAreaView style={[styles.main, { backgroundColor: theme.colors.card }]}>
      ...
      >
        ...
        >
          <ThemedView>{renderPromotionPreview()}</ThemedView>
          ...
          <View style={styles.headerContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => router.navigate("/createpromotion")}
            >
              <Ionicons name="add" size={24} color="white" />
            </TouchableOpacity>
          </View>

          <ThemedView>{renderPromotions()}</ThemedView>
        </ScrollView>
      </ThemedView>
    </SafeAreaView>
  );
